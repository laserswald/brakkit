...
(ert-deftest fill-string-with-alist ()
  ...
  (let ((inp1 "The Ghost of {$ holiday $} Past")
    ...
    (should (string= (brakkit-fill-string inp1 '((holiday . "Decemberween")))
		     "The Ghost of Decemberween Past"))
    (should (string= (brakkit-fill-string inp2 '((verb . "order")
						 (number . 12)))
		     "I would like to order 12 burgers, please."))))
